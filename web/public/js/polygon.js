...
// placeholder image
img.src = `http://localhost:15440/get_snapshot/${camera.id}`;
img.onload = function() {
...
document.getElementById('clear').addEventListener('click', function () {
    // Clear coordinates on image
    window.polygonData.config.mask = {};

    // Update hidden input
    document.getElementById('roiPoints').value = JSON.stringify(window.polygonData.config.mask);

    // Clear all poylygon on canvas
